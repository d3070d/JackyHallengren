...
Script Modifie par NourY Solutions pour preconfiguration du deploiement

 - Backup Destination (default) : \\BACKUP
 - Backup FULL Cleanup Time (default) : 20 heures
 - Backup LOG Cleanup Time (default) : 24 heures
 - Backup Checksum (default) : N
 - Purge Cleanup Time (default) : 30 jours

Les noms des jobs ont aussi ete modifie pour correspondre aux Standard
de NourY Solutions dans le cadre du deploiement de Maintenance
Microsoft SQL Server sur les versions 2005 et supérieures
Le job des Backups DIFF n'a pas ete garde par defaut

Des planifications par defaut ont ete ajoutees, mais les jobs laisses
desactives :
 - Backup System Full : Du Lundi au Vendredi, a 20H
 - Backup User Full : Du Lundi au Vendredi, a 20H
 - Backup User Log : Du Lundi au Vendredi, toutes les 2 heures de 0H00 a 19H30
 - DBCC System : Du Lundi au Vendredi, a 19H
 - DBCC User : Du Lundi au Vendredi, a 19H
 - INDEX OPTIMIZE : Dimanche a 10H
 - Cleanup : Dimanche a 8H00
